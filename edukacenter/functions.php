...
function edukacenter_scripts() {
	wp_enqueue_style( 'edukacenter-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'edukacenter-style', 'rtl', 'replace' );

	wp_enqueue_script( 'edukacenter-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
