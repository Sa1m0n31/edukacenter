...
function edukacenter_scripts() {
	wp_enqueue_style( 'edukacenter-style', get_stylesheet_uri() . '?n=7', array(), _S_VERSION );
	wp_enqueue_style('edukacenter-mobile', get_template_directory_uri() . '/mobile.css?n=7', array(), 1.0);
